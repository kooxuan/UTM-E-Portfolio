...
1. How has the global happiness score changed over time?
2. Is there a relationship between corruption and happiness?
3. Which continent has the highest average happiness score?
4. What factors contribute most to happiness?
5. Which countries are the happiest in the world?

✨ Highlights & Artifacts

Tableau Dashboard: An interactive workbook (Group 8 (Happiness Country in The World) .twbx) featuring maps, scatter plots, and trend lines to explore global well-being.

Data Storytelling: Translating complex socio-economic data (GDP, life expectancy, social support) into accessible, visual insights.

Video Presentation: A guided walkthrough of our data analysis process, dashboard interactivity, and final conclusions.

📺 Video Presentation
 https://youtu.be/ME3Cqdh7AOQ
